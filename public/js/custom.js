...
var Dots = /*#__PURE__*/function () {
  function Dots(canvasElement, width, height) {
...
var canvas = document.querySelector('#animation-pattern');
...
function generateElectroCircle(count) {
  ...
  new TWEEN.Tween(percent).to({
    ...
    yellowCircle.y = -10;
    setTimeout(function () {
      if (count + 1 === document.querySelectorAll('path[color]').length) generateElectroCircle(0);else generateElectroCircle(count + 1);
    }, 2000);
  }).start();
}
...
module.exports = __webpack_require__(/*! C:\Program Files\Ampps\www\menu\resources\js\custom.js */"./resources/js/custom.js");
